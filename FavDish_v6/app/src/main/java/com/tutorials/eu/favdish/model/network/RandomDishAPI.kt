...
interface RandomDishAPI {
    ...
    ): Single<com.tutorials.eu.favdish.model.data.RandomDish.Recipes> // The Single class implements the Reactive Pattern for a single value response. Click on the class using the Ctrl + Left Mouse Click to know more.
