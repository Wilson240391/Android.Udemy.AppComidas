...
class RandomDishViewModel : ViewModel() {
    ...
    val randomDishResponse = MutableLiveData<com.tutorials.eu.favdish.model.data.RandomDish.Recipes>()
    ...
    fun getRandomDishFromAPI() {
        ...
        compositeDisposable.add(
            ...
            randomRecipeApiService.getRandomDish()
                 ...
                 */
                .subscribeWith(object : DisposableSingleObserver<com.tutorials.eu.favdish.model.data.RandomDish.Recipes>() {
                    override fun onSuccess(value: com.tutorials.eu.favdish.model.data.RandomDish.Recipes?) {
