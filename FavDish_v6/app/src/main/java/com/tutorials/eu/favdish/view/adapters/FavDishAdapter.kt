...
class FavDishAdapter(private val fragment: Fragment, private val onItemEdit: (FavDish) -> Unit) :
    ListAdapter<FavDish, FavDishAdapter.ViewHolder>(DiffCallback) {
...
//                    fragment.requireActivity().startActivity(intent)
                    ...
                    if (fragment is AllDishesFragment) {
                        fragment.showConfirmationDialog(dish)
                    }
                }
                true
            }
    ...
    companion object{
        private val DiffCallback = object  : DiffUtil.ItemCallback<FavDish>() {
