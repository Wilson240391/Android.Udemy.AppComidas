...
import com.tutorials.eu.favdish.databinding.FragmentDishDetailBinding
...
class DishDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        args.let {
            ...
            SelectFavorite(args.dishDetails.favoriteDish)
        }
        // END
    ...
    private fun SelectFavorite(ivFavoriteDish: Boolean){
        if (ivFavoriteDish) {
